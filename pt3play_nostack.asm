...
;13.Jul.2014 - Removed SP code so that player could work with
;line interrupts, quick and dirty fix [TSL]
;27.Jun.2016 Unrolled cycle at LOUT for speedup, fixed OUTI,
;removed even more SP code, added F command [kowalski]
